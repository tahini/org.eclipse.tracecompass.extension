...
package org.eclipse.tracecompass.extension.analysis.core.tests;
...
public class Activator extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.analysis.core.tests"; //$NON-NLS-1$
