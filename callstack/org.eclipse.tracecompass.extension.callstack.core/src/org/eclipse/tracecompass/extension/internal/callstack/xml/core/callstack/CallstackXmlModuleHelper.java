...
package org.eclipse.tracecompass.extension.internal.callstack.xml.core.callstack;
...
import org.eclipse.tracecompass.extension.internal.callstack.core.Activator;
...
public class CallstackXmlModuleHelper extends TmfAnalysisModuleHelperXml {
    ...
    public CallstackXmlModuleHelper(File xmlFile, Element node) {
        ...
        // Create a helper for this module
        fHelper = new RefModuleHelper(childElements.get(0).getNodeValue());
        return;
    }
