package org.eclipse.tracecompass.extension.internal.perf.profiling.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.extension.perf.profiling.core"; //$NON-NLS-1$
