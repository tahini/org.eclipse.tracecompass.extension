...
package org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack;
...
import org.eclipse.tracecompass.extension.internal.timing.core.callstack.CallStackElement;
...
public interface ICallStackGroupDescriptor {
     ...
     */
    List<ICallStackElement> getElements(@Nullable CallStackElement parent, int baseQuark, @Nullable ICallStackElement symbolKeyElement, @Nullable IThreadIdResolver threadIdProvider);
