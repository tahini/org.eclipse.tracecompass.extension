...
package org.eclipse.tracecompass.extension.internal.timing.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.extension.timing.core"; //$NON-NLS-1$
