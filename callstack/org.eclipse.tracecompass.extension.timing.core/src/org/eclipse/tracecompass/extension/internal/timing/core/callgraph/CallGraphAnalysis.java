...
import org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack.CallStackSeries;
import org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack.ICallStackElement;
import org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack.ICallStackLeafElement;
import org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack.ICallStackProvider;
...
public class CallGraphAnalysis extends TmfAbstractAnalysisModule implements ISegmentStoreProvider {
    ...
    private void iterateOverCallstack(CallStack callstack, ICalledFunction function, int nextLevel, AggregatedCalledFunction aggregatedCall, IHostModel model, @NonNull IProgressMonitor monitor) {
        fStore.add(function);
...
//     */
//    @VisibleForTesting
//    protected boolean iterateOverProcesses(@Nullable ITmfStateSystem ss, String[] threadsPattern, String[] processesPattern, String[] callStackPath, IProgressMonitor monitor) {
//        if (ss == null) {
//            return false;
//        }
...
//                if (!iterateOverThread(ss, processId, threadQuark, callStackPath, monitor)) {
//                    return false;
//                }
//            }
//        }
...
//     * @return Boolean
//     */
//    private boolean iterateOverThread(ITmfStateSystem stateSystem, int processId, int threadQuark, String[] subAttributePath, IProgressMonitor monitor) {
//
//    }
//
//    /**
...
//     */
//    private boolean iterateOnStackRecursive(AbstractCalledFunction functionCall, int depth, ITmfStateSystem ss, List<Integer> callStackQuarks, AggregatedCalledFunction aggregatedCall, int processId, IProgressMonitor monitor) {
...
//                    return true;
//                }
//                AbstractCalledFunction childCall = CalledFunctionFactory.create(intervalStart, intervalEnd + 1, functionCall.getDepth() + 1, stateValue, processId, functionCall);
//                AggregatedCalledFunction childAggregated = new AggregatedCalledFunction(childCall, aggregatedCall);
//                // Search for the children with the next quark.
//                iterateOnStackRecursive(childCall, depth + 1, ss, callStackQuarks, childAggregated, processId, monitor);
