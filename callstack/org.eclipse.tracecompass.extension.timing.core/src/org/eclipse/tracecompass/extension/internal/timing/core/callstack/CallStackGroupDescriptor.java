...
package org.eclipse.tracecompass.extension.internal.timing.core.callstack;
...
import org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack.ICallStackGroupDescriptor;
import org.eclipse.tracecompass.extension.internal.provisional.timing.core.callstack.CallStackSeries.IThreadIdResolver;
...
public class CallStackGroupDescriptor implements ICallStackGroupDescriptor {
    ...
    @Override
    public List<@NonNull ICallStackElement> getElements(@Nullable CallStackElement parent, int baseQuark, @Nullable ICallStackElement symbolKeyElement, @Nullable IThreadIdResolver threadIdProvider) {
        ...
        for (Integer quark : quarks) {
            CallStackElement element = nextGroup == null ? new CallStackLeafElement(fHostId, fStateSystem, quark, symbolKeyElement, threadIdProvider, parent)
                    : new CallStackElement(fHostId, fStateSystem, quark, getNextGroup(), symbolKeyElement, threadIdProvider, parent);
            if (isSymbolKeyGroup()) {
