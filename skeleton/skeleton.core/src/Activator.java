package org.eclipse.tracecompass.extension.internal.{%skeleton}.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.extension.{%skeleton}.core"; //$NON-NLS-1$
