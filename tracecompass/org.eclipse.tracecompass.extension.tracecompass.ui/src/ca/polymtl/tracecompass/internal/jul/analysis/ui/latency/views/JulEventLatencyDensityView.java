 ...
 */
public class JulEventLatencyDensityView extends AbstractSegmentStoreDensityView {
     ...
     */
    public JulEventLatencyDensityView() {
        super(ID);
    }
    ...
    protected AbstractSegmentStoreDensityViewer createSegmentStoreDensityViewer(Composite parent) {
        return new JulEventDensityViewer(parent);
    }
